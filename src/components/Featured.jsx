        ...
        <div className='px-[30px]'>
            <div className='cards w-full flex gap-10 mt-10'>
                <motion.div onHoverStart={() => handleHover(0)} onHoverEnd={() => handleHoverEnd(0)} className='cardcontainer relative w-1/2 h-[75vh]'>
                    <h1
                     className='absolute z-[9] text-8xl leading-none tracking-tighter flex overflow-hidden left-full -translate-x-1/2 top-1/2 -translate-y-1/2 text-[#CDEA68]'>
                ...
                className='cardcontainer relative w-1/2 h-[75vh]'>
                    <h1 className='absolute z-[9] text-8xl flex overflow-hidden leading-none tracking-tighter right-full translate-x-1/2 top-1/2 -translate-y-1/2 text-[#CDEA68]'>
