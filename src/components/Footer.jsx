...
function Footer() {
  return (
    <div className='w-full h-screen flex gap-5 bg-zinc-900 p-20 font-["Founders Grotesk X Cond Lt"]'>
        <div className='w-1/2 h-full flex flex-col justify-between '>
            <div className='headings'>
                <h1 className='text-[7vw] font-bold uppercase -mb-2 leading-none'>Eye-</h1>
                <h1 className='text-[7vw] font-bold uppercase -mb-2 leading-none'>Opening</h1>
            </div>
        ...
        <div className='w-1/2'>
            <h1 className='text-[6vw] font-bold uppercase -mb-2 leading-none'>Presentations</h1>
